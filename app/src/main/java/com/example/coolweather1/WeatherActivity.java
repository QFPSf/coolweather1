    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                String weatherString1=prefs.getString("weather",null);//5.这里添加向缓存中获取数据的操作，如果不添加，就得不到
                Weather weather=Utility.handleWeatherResponse(weatherString1);//      requestWeather中的参数。
